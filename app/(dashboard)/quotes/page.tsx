    ...
    <section className="space-y-[22px]">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="min-h-[124px] rounded-2xl border border-border bg-card p-5 shadow-[var(--surface-shadow)]">
          ...
          <div className="relative mt-2 w-full lg:w-[200px]">
            <select
              value={statusFilter}
      ...
      <div className="grid gap-4 rounded-2xl border border-border bg-card px-5 py-[22px] shadow-[var(--surface-shadow)] sm:grid-cols-2 lg:grid-cols-[minmax(300px,1fr)_190px_160px] lg:pr-7">
        <div>
